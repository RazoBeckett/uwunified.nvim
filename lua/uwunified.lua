...
function M.load_colors()
    ...
    local syntax = {
        ...
        SpellBad = { gui = "undercurl", fg = colors.none },
        SpellCap = { gui = "undercurl", fg = colors.none },
        SpellLocal = { gui = "undercurl", fg = colors.none },
        SpellRare = { gui = "undercurl", fg = colors.none },
        -- Diagnostics
        ...
        DiagnosticUnderlineWarn = { gui = "undercurl", sp = colors.yellow },
